...
OS=`uname -m`;
if [ $OS = 'i686' ]; then
	wget https://github.com/VikriAulia/CentOS6/raw/master/rpmforge-release-0.5.3-1.el6.rf.i686.rpm
elif [ $OS = 'x86_64' ]; then
	wget https://github.com/VikriAulia/CentOS6/raw/master/rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm
fi
